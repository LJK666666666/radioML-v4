...
def create_derivation_flowchart():
    ...
    # Arrow 1
    arrow1 = ConnectionPatch((5, 9.5), (5, 8.9), "data", "data",
    ...
    # Arrow 2
    arrow2 = ConnectionPatch((5, 7.5), (5, 6.9), "data", "data",
                            arrowstyle="->", shrinkA=5, shrinkB=5, 
                            mutation_scale=20, fc=arrow_color, ec=arrow_color, lw=2)
    ax.add_patch(arrow2)
    ...
    # Arrow 3
    arrow3 = ConnectionPatch((5, 5.5), (5, 4.9), "data", "data",
                            arrowstyle="->", shrinkA=5, shrinkB=5, 
                            mutation_scale=20, fc=arrow_color, ec=arrow_color, lw=2)
    ax.add_patch(arrow3)
    ...
    # Arrow 4
    arrow4 = ConnectionPatch((5, 3.5), (5, 2.9), "data", "data",
                            arrowstyle="->", shrinkA=5, shrinkB=5, 
                            mutation_scale=20, fc=arrow_color, ec=arrow_color, lw=2)
    ax.add_patch(arrow4)
    
    # Final Result
    result_box = FancyBboxPatch((2, 1.5), 6, 1, 
                                boxstyle="round,pad=0.1", 
                                facecolor=result_color, 
                                edgecolor='darkgreen', linewidth=2)
    ax.add_patch(result_box)
    ax.text(5, 2.1, 'Final Result: Theoretically Grounded Noise Estimation', 
            ha='center', va='center', fontsize=11, fontweight='bold', color='darkgreen')
    ax.text(5, 1.7, r'$\sigma_n = \sqrt{\frac{P_r}{2(10^{\text{SNR}_{\text{dB}}/10} + 1)}}$', 
            ha='center', va='center', fontsize=11, fontweight='bold')
