...
\vspace{-0.5cm}
\begin{center}
{\large \textbf{GRCR-Net: A Complex Residual Network with GPR Denoising\\and Rotational Augmentation for Automatic Modulation Classification}}

\vspace{0.8cm}
{\normalsize \textit{A Breakthrough Approach for AMC}}

\vspace{1cm}
{\normalsize \textbf{Junkai Li}}

\vspace{0.5cm}
{\small College of Information Engineering\\
