...
\fill[zjutblue!30] (0,0) rectangle (0.2,4);
\fill[zjutred!30] (0.2,0) rectangle (4,4);

\node[anchor=south] at (0.1,4.1) {\tiny Signal 1\%};
\node[anchor=south] at (2.1,4.1) {\tiny Noise 99\%};

\node[anchor=north] at (2,-0.3) {SNR = -20dB};

% Arrow showing improvement
\draw[thick,->] (4.5,2) -- (6,2);
\node at (5.25,2.5) {\tiny GPR};

% After denoising
\fill[zjutblue!70] (6.5,0) rectangle (8.5,4);
\node[anchor=south] at (7.5,4.1) {\tiny Denoised};
\end{tikzpicture}
\end{center}
\end{column}
\end{columns}
...
\begin{center}
\begin{tikzpicture}[scale=0.8]
\node[draw,rectangle,fill=zjutgreen!20,text width=8cm,align=center] at (0,0) {
